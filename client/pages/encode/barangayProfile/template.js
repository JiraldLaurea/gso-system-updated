...
function template({
    ...
    useEffect(() => {
        ...
        dispatch(
            "CHANGE_TITLE",
            `Barangay profile - ${selectedBarangayData?.selectedBarangay}`
        );
        dispatch("CHANGE_PATH", "/encode/barangayProfile");
    ...
    const [values, setValues] = useState({
        ...
        crops1: page2Data.crops1,
        crops2: page2Data.crops2,
        crops3: page2Data.crops3,
        crops1Num: page2Data.crops1Num,
        crops2Num: page2Data.crops2Num,
        crops3Num: page2Data.crops3Num,
        crops1YieldYearKg: page2Data.crops1YieldYearKg,
        crops2YieldYearKg: page2Data.crops2YieldYearKg,
        crops3YieldYearKg: page2Data.crops3YieldYearKg,
        numFarmersTenants1: page2Data.numFarmersTenants1,
        numFarmersTenants2: page2Data.numFarmersTenants2,
        numFarmersTenants3: page2Data.numFarmersTenants3,
        ...
        educInstruction1: page6Data.educInstruction1,
        educInstruction2: page6Data.educInstruction2,
        educInstruction3: page6Data.educInstruction3,
        educInstruction4: page6Data.educInstruction4,
        educInstruction5: page6Data.educInstruction5,
        ...
        educInstructionPublic4: page6Data.educInstructionPublic4,
        educInstructionPrivate4: page6Data.educInstructionPrivate4,
        educInstructionDayCare4: page6Data.educInstructionDayCare4,
        educInstructionPreschoolKinder4:
            page6Data.educInstructionPreschoolKinder4,
        educInstructionElementary4: page6Data.educInstructionElementary4,
        educInstructionSecondary4: page6Data.educInstructionSecondary4,
        educInstructionTertiaryCollege4:
            page6Data.educInstructionTertiaryCollege4,
        educInstructionPostGraduate4: page6Data.educInstructionPostGraduate4,
        educInstructionPublic5: page6Data.educInstructionPublic5,
        educInstructionPrivate5: page6Data.educInstructionPrivate5,
        educInstructionDayCare5: page6Data.educInstructionDayCare5,
        educInstructionPreschoolKinder5:
            page6Data.educInstructionPreschoolKinder5,
        educInstructionElementary5: page6Data.educInstructionElementary5,
        educInstructionSecondary5: page6Data.educInstructionSecondary5,
        educInstructionTertiaryCollege5:
            page6Data.educInstructionTertiaryCollege5,
        educInstructionPostGraduate5: page6Data.educInstructionPostGraduate5,
        // Page 7
    ...
    const updateSubmissionBarangayProfilePage2 = async () => {
        ...
        const data = {
            ...
            crops1: values.crops1,
            crops2: values.crops2,
            crops3: values.crops3,
            crops1Num: values.crops1Num,
            crops2Num: values.crops2Num,
            crops3Num: values.crops3Num,
            crops1YieldYearKg: values.crops1YieldYearKg,
            crops2YieldYearKg: values.crops2YieldYearKg,
            crops3YieldYearKg: values.crops3YieldYearKg,
            numFarmersTenants1: values.numFarmersTenants1,
            numFarmersTenants2: values.numFarmersTenants2,
            numFarmersTenants3: values.numFarmersTenants3,
    ...
    const updateSubmissionBarangayProfilePage6 = async () => {
        const data = {
            ...
            educInstruction1: values.educInstruction1,
            educInstruction2: values.educInstruction2,
            educInstruction3: values.educInstruction3,
            educInstruction4: values.educInstruction4,
            educInstruction5: values.educInstruction5,
            ...
            educInstructionPublic4: values.educInstructionPublic4,
            educInstructionPrivate4: values.educInstructionPrivate4,
            educInstructionDayCare4: values.educInstructionDayCare4,
            educInstructionPreschoolKinder4:
                values.educInstructionPreschoolKinder4,
            educInstructionElementary4: values.educInstructionElementary4,
            educInstructionSecondary4: values.educInstructionSecondary4,
            educInstructionTertiaryCollege4:
                values.educInstructionTertiaryCollege4,
            educInstructionPostGraduate4: values.educInstructionPostGraduate4,
            educInstructionPublic5: values.educInstructionPublic5,
            educInstructionPrivate5: values.educInstructionPrivate5,
            educInstructionDayCare5: values.educInstructionDayCare5,
            educInstructionPreschoolKinder5:
                values.educInstructionPreschoolKinder5,
            educInstructionElementary5: values.educInstructionElementary5,
            educInstructionSecondary5: values.educInstructionSecondary5,
            educInstructionTertiaryCollege5:
                values.educInstructionTertiaryCollege5,
            educInstructionPostGraduate5: values.educInstructionPostGraduate5,
        };
        ...
        await Axios.post("http://localhost:3001/submission/submit", data).then(
            async () => {
                ...
                await Axios.put(
                    ...
                    {
                        populationCount: totalPopulationCount,
                        barangayId: selectedBarangayData?.barangayId,
                    }
                );
            }
        );
                ...
                <div className="h-[calc(100vh-56px)] sticky top-[56px] bg-gray-50 flex flex-col py-4 border-l  w-full max-w-[260px] overflow-y-auto">
                    ...
                    <div className="px-4">
                        <button
                            ...
                            className={`w-full flex items-center justify-center px-3 py-2  text-blue-500 border border-gray-300 rounded-sm ${
                                isLoading
                    ...
                    <div className="px-4">
                        {actionData != "UpdateSubmission" && (
                            <button
                                disabled={isLoading}
                                onClick={attemptSave}
                                className={`w-full flex items-center justify-center px-3 py-2 mb-4 text-white bg-green-500 transition-colors rounded-sm ${
                                    isLoading
                                        ? "cursor-not-allowed hover:bg-green-500"
                                        : "hover:bg-green-600"
                                }`}
                            >
                                <Icon
                        ...
                        <button
                            disabled={isLoading}
                            onClick={submitEncodedDocuments}
