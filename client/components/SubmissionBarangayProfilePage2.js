    ...
    return (
        <div>
            ...
            <input
                ...
                type="text"
                className="w-full ml-4 border-b border-black focus:outline-none"
                onChange={handleChange}
            />
                        ...
                        <tbody className="font-normal">
                            <tr className="border-t">
                                ...
                                <td className="text-center border-x">
                                    <input
                                        name="crops1YieldYearKg"
                                        value={values?.crops1YieldYearKg}
                                        type="number"
                                        className="w-full text-center focus:outline-none"
                                        onChange={handleChange}
                                    />
                                ...
                                <td className="text-center">
                                    <input
                                        name="numFarmersTenants1"
                                        value={values?.numFarmersTenants1}
                                        type="number"
                                        className="w-full text-center focus:outline-none"
                                        onChange={handleChange}
                                    />
                            ...
                            <tr className="border-t">
                                ...
                                <td className="text-center border-x">
                                    <input
                                        name="crops2YieldYearKg"
                                        value={values?.crops2YieldYearKg}
                                        type="number"
                                        className="w-full text-center focus:outline-none"
                                        onChange={handleChange}
                                    />
                                ...
                                <td className="text-center">
                                    <input
                                        name="numFarmersTenants2"
                                        value={values?.numFarmersTenants2}
                                        type="number"
                                        className="w-full text-center focus:outline-none"
                                        onChange={handleChange}
                                    />
                            ...
                            <tr className="border-t">
                                ...
                                <td className="text-center border-x">
                                    <input
                                        name="crops3YieldYearKg"
                                        value={values?.crops3YieldYearKg}
                                        type="number"
                                        className="w-full text-center focus:outline-none"
                                        onChange={handleChange}
                                    />
                                ...
                                <td className="text-center">
                                    <input
                                        name="numFarmersTenants3"
                                        value={values?.numFarmersTenants3}
                                        type="number"
                                        className="w-full text-center focus:outline-none"
                                        onChange={handleChange}
                                    />
