        ...
        <div>
            ...
            <div>
                ...
                <table className="w-full text-xs border">
                    <thead className="font-bold">
                        <tr>
                            <th rowSpan={2} className="w-24 border-r">
                        ...
                        <tr>
                            <th className="w-10 border-r">Gov't</th>
                            <th className="w-10">Private</th>
                            <th className="w-10">Gov't</th>
                            <th className="w-10 border-x">Private</th>
