            ...
            <table className="w-full text-xs border">
                ...
                <tbody>
                    <tr className="border-t">
                        <td className="pl-2">
                            <input
                                name="educInstruction1"
                                value={values?.educInstruction1}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
                    ...
                    <tr className="border-t">
                        <td className="pl-2">
                            <input
                                name="educInstruction2"
                                value={values?.educInstruction2}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
                    ...
                    <tr className="border-t">
                        <td className="pl-2">
                            <input
                                name="educInstruction3"
                                value={values?.educInstruction3}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
                    ...
                    <tr className="border-t">
                        <td className="pl-2">
                            <input
                                name="educInstruction4"
                                value={values?.educInstruction4}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
                        ...
                        <td className="border-x">
                            <input
                                name="educInstructionPublic4"
                                value={values?.educInstructionPublic4}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
                        ...
                        <td>
                            <input
                                name="educInstructionPrivate4"
                                value={values?.educInstructionPrivate4}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
                        ...
                        <td className="border-x">
                            <input
                                name="educInstructionDayCare4"
                                value={values?.educInstructionDayCare4}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
                        ...
                        <td>
                            <input
                                name="educInstructionPreschoolKinder4"
                                value={values?.educInstructionPreschoolKinder4}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
                        ...
                        <td className="border-x">
                            <input
                                name="educInstructionElementary4"
                                value={values?.educInstructionElementary4}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
                        ...
                        <td>
                            <input
                                name="educInstructionSecondary4"
                                value={values?.educInstructionSecondary4}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
                        ...
                        <td className="border-x">
                            <input
                                name="educInstructionTertiaryCollege4"
                                value={values?.educInstructionTertiaryCollege4}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
                        ...
                        <td>
                            <input
                                name="educInstructionPostGraduate4"
                                value={values?.educInstructionPostGraduate4}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
                    ...
                    <tr className="border-t">
                        <td className="pl-2">
                            <input
                                name="educInstruction5"
                                value={values?.educInstruction5}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
                        ...
                        <td className="border-x">
                            <input
                                name="educInstructionPublic5"
                                value={values?.educInstructionPublic5}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
                        ...
                        <td>
                            <input
                                name="educInstructionPrivate5"
                                value={values?.educInstructionPrivate5}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
                        ...
                        <td className="border-x">
                            <input
                                name="educInstructionDayCare5"
                                value={values?.educInstructionDayCare5}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
                        ...
                        <td>
                            <input
                                name="educInstructionPreschoolKinder5"
                                value={values?.educInstructionPreschoolKinder5}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
                        ...
                        <td className="border-x">
                            <input
                                name="educInstructionElementary5"
                                value={values?.educInstructionElementary5}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
                        ...
                        <td>
                            <input
                                name="educInstructionSecondary5"
                                value={values?.educInstructionSecondary5}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
                        ...
                        <td className="border-x">
                            <input
                                name="educInstructionTertiaryCollege5"
                                value={values?.educInstructionTertiaryCollege5}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
                        ...
                        <td>
                            <input
                                name="educInstructionPostGraduate5"
                                value={values?.educInstructionPostGraduate5}
                                type="text"
                                className="w-full text-center focus:outline-none"
                                onChange={handleChange}
                            />
